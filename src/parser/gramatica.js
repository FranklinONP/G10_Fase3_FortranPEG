...
function peg$parse(input, options) {
  ...
  var peg$e37 = peg$classExpectation(["\"", "'", "\\", "b", "f", "n", "r", ["t", "v"]], false, false);
  var peg$e38 = peg$literalExpectation("\r\n", false);
  var peg$e39 = peg$classExpectation(["\n", "\r", ["\u2028", "\u2029"]], false, false);
  var peg$e40 = peg$classExpectation([["0", "9"]], false, false);
  var peg$e41 = peg$classExpectation(["_", ["a", "z"]], false, true);
  var peg$e42 = peg$classExpectation(["_", ["a", "z"], ["0", "9"]], false, true);
  ...
  var peg$f15 = function(inicio) {return {min: inicio, tipo: "unico1"}};
  var peg$f16 = function(min, max) {return {min: min, max: max, tipo: "rango1"}};
  ...
  var peg$f19 = function(assert, returnType, code) {
  ...
  var peg$f21 = function(assert, returnType, code, returnType2, code2) {
    return new n.Predicate(returnType, code, {}, qty_actual,assert,'rango1')
  };
  var peg$f22 = function(assert, returnType, code, opciones) {
    return new n.Predicate(returnType, code, opciones, qty_actual,assert,'unico2')
  };
  var peg$f23 = function(assert, returnType, code, returnType2, code2, opciones) {
    return new n.Predicate(returnType, code, opciones, qty_actual,assert,'rango2')
  };
  var peg$f24 = function(t) {
    return t.trim();
  };
  var peg$f25 = function(contenido) {
        return contenido;
    };
  var peg$f26 = function(inicio, fin) {
        return new  n.Rango(inicio, fin);
    };
  var peg$f27 = function(contenido) {
    ...
    if (s0 === peg$FAILED) {
      ...
      if (s3 !== peg$FAILED) {
        ...
        if (s5 !== peg$FAILED) {
          ...
          s7 = peg$parsepredicateReturnType();
          if (s7 !== peg$FAILED) {
            s8 = peg$currPos;
            s9 = [];
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s5 !== peg$FAILED) {
            ...
            s8 = peg$parsepredicateReturnType();
            if (s8 !== peg$FAILED) {
              s9 = peg$currPos;
              s10 = [];
              ...
              if (s11 !== peg$FAILED) {
                ...
                if (s13 !== peg$FAILED) {
                  ...
                  if (s15 !== peg$FAILED) {
                    ...
                    s18 = peg$parsepredicateReturnType();
                    if (s18 !== peg$FAILED) {
                      s19 = peg$currPos;
                      s20 = [];
                          ...
                          if (s21 !== peg$FAILED) {
                            ...
                            if (s23 !== peg$FAILED) {
                              ...
                              if (s25 !== peg$FAILED) {
                                ...
                                if (s27 !== peg$FAILED) {
                                  peg$savedPos = s0;
                                  s0 = peg$f23(s1, s8, s9, s18, s19, s25);
                                } else {
                                  peg$currPos = s0;
                                  s0 = peg$FAILED;
                                }
